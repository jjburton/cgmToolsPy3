...
def screenToWorld(screen_pos, distance, asEuclid = False):
    # Get active view
    active_view = omui.M3dView.active3dView()
    ...
    if abs(homogenous_world_point.w) > 1e-6:  # avoid division by a very small number
        world_point = om.MPoint(homogenous_world_point.x / homogenous_world_point.w,
                                homogenous_world_point.y / homogenous_world_point.w,
                                homogenous_world_point.z / homogenous_world_point.w)
    else:
        world_point = homogenous_world_point
