# Artist hair presets: cgm/cgmDat/sim/hair/*.cgmSimHairDat (Presets → Hair in dynFK).
# This module keeps base/d_chain seed data + script API (profile_load, Query Settings diffs).
base =  {'n':
{'airDensity': 1.0,
...
tail_firm = {'hs': {'attractionScale': {0: (0.0, 1.0, 1.0),
                            1: (0.25, 0.65, 1.0),
                            2: (0.55, 0.22, 1.0),
                            3: (0.9, 0.04, 1.0)},
        'bendResistance': 0.22,
        'compressionResistance': 55.0,
        'damp': 0.08,
        'drag': 0.35,
        'extraBendLinks': 2,
        'gravity': 1.0,
        'mass': 18.0,
        'motionDrag': 0.25,
        'startCurveAttract': 0.58,
        'stiffnessScale': {0: (0.0, 0.82, 1.0),
                           1: (0.35, 0.5, 1.0),
                           2: (0.7, 0.22, 1.0),
                           3: (1.0, 0.1, 1.0)},
        'stretchDamp': 0.06,
        'stretchResistance': 185.0,
        'tangentialDrag': 0.18}}
...
ponytail = {'hs': {'attractionScale': {0: (0.0, 1.0, 1.0),
        ...
        'motionDrag': 0.28,
        'selfCollide': True,
        'startCurveAttract': 0.38,
        'stiffnessScale': {0: (0.0, 0.7, 1.0),
                           1: (0.45, 0.25, 1.0),
                           2: (1.0, 0.1, 1.0)},
        'stretchDamp': 0.05,
        'stretchResistance': 175.0,
        'tangentialDrag': 0.16}}
...
bob = {'hs': {'attractionScale': {0: (0.0, 1.0, 1.0),
                            ...
                            3: (0.8, 0.14, 1.0)},
        'bendResistance': 0.28,
        'compressionResistance': 38.0,
        'damp': 0.09,
        'drag': 0.35,
        'extraBendLinks': 2,
        'mass': 8.0,
        'motionDrag': 0.25,
        'startCurveAttract': 0.7,
        'stiffnessScale': {0: (0.0, 0.82, 1.0),
                           1: (0.36, 0.5, 1.0),
                           2: (1.0, 0.22, 1.0)},
        'stretchResistance': 195.0,
        'stretchDamp': 0.1,
        'tangentialDrag': 0.18}}

bob_hold = {'hs': {'attractionScale': {0: (0.0, 1.0, 1.0),
                            1: (0.2, 0.7, 1.0),
                            2: (0.5, 0.4, 1.0),
                            3: (0.8, 0.15, 1.0)},
        'bendResistance': 0.35,
