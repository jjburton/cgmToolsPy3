...
d_attrsToMake = {'faceType':'default:muzzle:beak',
                 'defineProfile':'human:muzzle:beak:muppet:dragon',
...
_d_scaleSpace = {
    ...
    'dragon':
    {'bridge': [0, 1.0190956160498468, 0.7652602867451961],
     'bridgeOuterLeft': [0.2842779624889498, 0.888228507523456, 0.6207478942047442],
     'bridgeOuterRight': [-0.2842779624889498,
                          0.888228507523456,
                          0.6207478942047442],
     'bridgeRight': [-0.12541064046401423, 0.9747714521978192, 0.7433900299608331],
     'bulb': [0, 0.769623463510948, 0.9250707805677933],
     'bulbRight': [-0.13607117655315565, 0.8833742835338665, 0.9046187335012243],
     'cheekBoneRight': [-0.619241201046498,
                        -0.07889320644593933,
                        0.354039208208341],
     'cheekRight': [-0.7057773737536126, -0.6009074283109763, -0.04109287227175473],
     'chinRight': [-0.13157625126722441, -1.0283914325648675, 0.729731610014352],
     'cornerBackRight': [-0.4270850347788892,
                         -0.4797448938119464,
                         0.13469308011208003],
     'cornerBagRight': [-0.3688942739705123,
                        -0.4970247542366977,
                        0.05586670728447318],
     'cornerFrontRight': [-0.48002084153688,
                          -0.47974489381195085,
                          0.17269835566788494],
     'cornerLwrRight': [-0.49262320799501447,
                        -0.6026198490502992,
                        0.15826681988478564],
     'cornerPeakRight': [-0.5008399963580842,
                         -0.46548467830889084,
                         0.14035424805871832],
     'cornerUprRight': [-0.584686882045543,
                        -0.302878662410091,
                        0.19156594703629226],
     'jawFrontRight': [-0.1050195248592519,
                       -1.2310221420485847,
                       0.6329713518703297],
     'jawNeck': [-2.640974516242066e-18, -1.2770905559193224, -0.3801455690519089],
     'jawNeckRight': [-0.5180351793628238,
                      -0.832199776367478,
                      -0.11477381025632827],
     'jawRight': [-0.7461878182603638, -0.6862662280827578, -0.455059852617806],
     'jawTopRight': [-0.999307240070871, 0.3510781064828299, -0.2912504358453889],
     'lwrBack': [0, -0.3061488968445252, 0.7785087274070772],
     'lwrBackRight': [-0.2051637424641387, -0.4783037296909498, 0.5822862559236714],
     'lwrFront': [0, -0.2997663105652508, 0.855502442030672],
     'lwrFrontRight': [-0.2503761283525535,
                       -0.4588442835655506,
                       0.6384684595943737],
     'lwrGum': [-2.640974516242066e-18, -0.8082245397648613, 0.6903150248046757],
     'lwrOver': [0, -0.9398734897624133, 0.7958986298745643],
     'lwrOverRight': [-0.15925328106736394,
                      -0.8787864832522043,
                      0.7483604780434057],
     'lwrPeak': [-2.640974516242066e-18, -0.5496086757043317, 0.8251903979605997],
     'lwrPeakRight': [-0.22753683541868416, -0.6671786773219095, 0.674190567015013],
     'mouthBagBack': [0, -0.13122905707918253, -0.5400968751764661],
     'mouthBagBottom': [0, -0.9367670604839491, 0.06562407766225764],
     'mouthBagRight': [-0.3566316014125754,
                       -0.15843981871730772,
                       -0.4704096352971181],
     'mouthBagTop': [0, 0.42537992130512237, 0.0852894564161053],
     'noseBase': [0, 0.26182610445640275, 1.0937857574600818],
     'noseBaseRight': [-0.14620190093895688, 0.32742779878107964, 1.02787668614285],
     'noseTip': [0, 0.6230644139857331, 1.031516796643536],
     'noseTipRight': [-0.17386434952680332, 0.8321875043902986, 0.9529669801182861],
     'noseTop': [-1.0563898064968264e-17, 1.544884535522753, 0.6817849370419062],
     'noseTopRight': [-0.10734668072492631, 1.491715748976632, 0.6483041862017385],
     'noseUnder': [0, 0.44479880196267185, 1.0727380829011652],
     'nostrilBaseRight': [-0.3332048895089123,
                          0.551602805887975,
                          0.7802500711439606],
     'nostrilLineInnerLeft': [0.13832151913867122,
                              0.6514028240905718,
                              1.0206201621033113],
     'nostrilLineInnerRight': [-0.13832151913867122,
                               0.6514028240905718,
                               1.0206201621033113],
     'nostrilLineOuterRight': [-0.22813208401891,
                               0.7507100016089936,
                               0.9624816379628349],
     'nostrilRight': [-0.33850270861833553, 0.6718665716668077, 0.7393317011853808],
     'nostrilTopRight': [-0.29806142718482287,
                         0.7790648992356859,
                         0.6804154844744859],
     'orbFrontRight': [-0.5823012196465858, 0.5254483080141732, 0.4464860701675808],
     'orbRight': [-0.9283149840686566, 0.3765672219962859, -0.07132553339526382],
     'smileRight': [-0.5812296008309019, -0.5827927966293984, 0.05340928836933445],
     'sneerRight': [-0.281220531210927, 1.0333807175167617, 0.5597523329837277],
     'uprBack': [0, -0.848675517920392, 0.835574260109087],
     'uprBackRight': [-0.22883495781921181,
                      -0.5845904384339002,
                      0.5904356822317913],
     'uprFront': [0, -0.8690837370612821, 0.9134699798835992],
     'uprFrontRight': [-0.2866012025536584,
                       -0.5845904384338967,
                       0.6652947227642159],
     'uprGum': [0, -0.004041919318814813, 0.7940698579938044],
     'uprOver': [0, -0.31249361437508494, 1.0504485629686897],
     'uprOverRight': [-0.33581382668346205,
                      -0.27693262225218085,
                      0.7685823491640313],
     'uprPeak': [0.002571044021112876, -0.730512483992622, 0.9534192347379866],
     'uprPeakRight': [-0.31167690043308854,
                      -0.4782952885101359,
                      0.7219748872755689]}
}
...
def create_simpleMesh(self, deleteHistory=True, skin=True, parent=False, **kws):
    ...
    _res = build_proxyMesh(self, simpleMeshMode=True, skin=skin, **kws)
    if not _res:
        return []
    if parent:
        for mObj in _res:
...
def build_proxyMesh(self, forceNew = True, puppetMeshMode = False, simpleMeshMode = False, skin = False, **kws):
    """
    Build our proxyMesh
    """
    _short = self.p_nameShort
    ...
    if puppetMeshMode:
        ...
        mRigNull.msgList_connect('puppetProxyMesh', ml_puppet + ml_curves)
        return ml_puppet + ml_curves

    if simpleMeshMode:
        return ml_proxy + ml_curves
...
def uiFunc_getDefineScaleSpace(self):
    ...
    return self.atUtils('get_handleScaleSpace',ml_handles)
