...
_d_faceBufferAttributes = {
    ...
    'fortniteMetaHuman':{
        "nose":{'attrs':['up','dn','left','right'],
               },
        "eyes":{'attrs':['convergence','divergence'],
               },
        "eyelidsUpr":{'attrs':['up','dn','in','out'],
                     "sideAttrs":'*'},
        "eyelidsLwr":{'attrs':['up','dn','in','out'],
                    "sideAttrs":'*'},
        "brow":{'attrs':['inner_up','inner_dn','outer_up','outer_dn'],
                "sideAttrs":'*'},
        "teeth":{'attrs':['rotateU_up','rotateU_dn','rotateD_up','rotateD_dn'],
                },
    }, 
