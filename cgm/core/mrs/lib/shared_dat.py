...
d_uiAttrDict = {'name':['nameList','cgmName','nameIter'],
                ...
                'form':['numShapers','numSubShapers','formAim','shapersAim','shapersAimUp',
                        'loftSetup','loftList','loftShape','loftShapeEnd','loftShapeStart',
                        'proxyShape'],
                'proxySurface':['loftSides','loftDegree','loftSplit','meshBuild','proxyBuild','proxyEnd','castVector','proxyGeoCap','proxyHardenEdge'],
                ...
                'space':['numSpacePivots','spaceSwitch_fk','spaceSwitch_direct','dynParentModeEnabled',
...
_d_attrsTo_make = {'side':'none:left:right:center',
                   ...
                   'proxyType':'none:castMesh:geoOnly:comboMesh',
